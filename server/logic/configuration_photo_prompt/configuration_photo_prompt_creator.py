...
class ConfigurationPhotoPromptCreator:
    ...
    def _build_single_param_prompt_line(self, param_name: str, param_value: Union[float, list]) -> PromptComponent:
        ...
        if isinstance(param_value, list):
            ...
            return self._build_numeric_param_prompt(param_name, formatted_param_name, param_value)
    ...
    def _build_numeric_param_prompt(self, raw_param_name: str, formatted_param_name: str, param_value: float) -> PromptComponent:
        z_score = self._z_score_calculator.calculate(param_value, formatted_param_name)

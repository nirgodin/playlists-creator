...
from server.consts.audio_features_consts import NUMERIC_AUDIO_FEATURES, KEY, KEY_NAMES_MAPPING
...
KEY_COLUMNS = [f'{KEY}_{key_name}' for key_name in KEY_NAMES_MAPPING.values()]
DATABASE_COLUMNS = NUMERIC_AUDIO_FEATURES + NON_AUDIO_DATABASE_COLUMNS + KEY_COLUMNS

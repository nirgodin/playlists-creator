...
from server.consts.audio_features_consts import AUDIO_FEATURES, KEY, KEY_NAMES_MAPPING
...
DATABASE_COLUMNS = AUDIO_FEATURES + NON_AUDIO_DATABASE_COLUMNS + KEY_COLUMNS

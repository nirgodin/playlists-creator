...
from server.api_consts import TOKEN_REQUEST_URL, CLIENT_ID, RESPONSE_TYPE, REDIRECT_URI, CODE, SCOPE, \
    AUTHORIZATION_REQUEST_URL_FORMAT, GRANT_TYPE, JSON, ACCESS_TOKEN
from server.env_consts import SPOTIPY_CLIENT_SECRET, SPOTIPY_CLIENT_ID, SPOTIPY_REDIRECT_URI, SPOTIPY_PORT

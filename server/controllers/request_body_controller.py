...
from server.utils.general_utils import get_column_min_max_values, get_column_possible_values
...
class RequestBodyController(Resource):
    ...
    @staticmethod
    def _get_features_values(features_names: Dict[str, List[str]]) -> Dict[str, Dict[str, List[float]]]:
        min_max_values = {feature: get_column_min_max_values(feature) for feature in features_names[MIN_MAX_VALUES]}
        possible_values = {feature: get_column_possible_values(feature) for feature in features_names[POSSIBLE_VALUES]}

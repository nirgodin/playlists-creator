...
class ExistingPlaylistController(BaseContentController):
    ...
    def _generate_tracks_uris(self, request_body: dict) -> Optional[List[str]]:
        existing_playlist_id = request_body[PLAYLIST_DETAILS][EXISTING_PLAYLIST]
        tracks_uri = asyncio.run(self._playlist_imitator.imitate_playlist(existing_playlist_id))

        return tracks_uri

    def _generate_playlist_cover_prompt(self, request_body: dict) -> str:
        raise  # TODO: Rethink how to genrate cover here
